...
public class Pizza {
    ...
    public Pizza (){
        ...
        ValuesOfPizza meatlover = new ValuesOfPizza("Meatlover", "Tomatsovs, ost, oksekød og pepperoni", 80);
        ValuesOfPizza bello = new ValuesOfPizza("Bello", "Tomatsovs, ost, svampe og champingoner", 70);
        ValuesOfPizza mamma = new ValuesOfPizza("Mamma", "Tomatsovs, ost og friske tomater", 90);
        ValuesOfPizza smello = new ValuesOfPizza("Smello", "Tomatsovs, ost, feta og gorgonzolla", 30);
