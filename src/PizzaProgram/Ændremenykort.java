...
public class Ændremenykort { //herinde foregår ændringen af menykortet
        ...
        public void changePrice(){
            ...
            if (index >= 0 && index < menyPizza.size()) {
                ...
                System.out.println("Ingredienserne for '" + ValuesOfPizza.menyPizza.get(index).navn + "' er nu opdateret til: " + nyeIngredienser);
            } else {
                System.out.println("Ugyldigt valg. Prøv igen.");
            }
